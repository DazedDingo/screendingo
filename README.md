<p align="center">
  <img src="android/app/src/main/res/mipmap-xxxhdpi/ic_launcher.png" width="128" alt="ScreenDingo app icon"/>
</p>
...
- Animated *Screen**Dingo*** wordmark on the title bar, splash, and login.
...
- **Android share sheet** — hit "Share" from IMDb, Letterboxd, Google, or any browser and ScreenDingo offers to save the title straight to your watchlist.
...
5. **Trademark sanity-check "ScreenDingo"** on USPTO TESS / EUIPO eSearch
